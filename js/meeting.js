...
document.getElementsByClassName("modal-content")[0].innerHTML += meetingFormContents;

// --- set meeting link active ---
document.querySelector("#sidebar")
    .getElementsByClassName("fa-handshake")[0]
...
document.querySelector("#add-btn").addEventListener("click", () => {
    ...
    document.querySelector("#modal-heading").textContent = "Enter Meeting Details";
...
for(let i = 0; i < viewBtns.length; i++) {
    viewBtns[i].addEventListener("click", (e) => {
        ...
        document.querySelector("#modal-heading").textContent = "Meeting Details";
...
for(let i = 0; i < editBtns.length; i++) {
    editBtns[i].addEventListener("click", (e) => {
        ...
        setInputsOfModal(values, true);
        modal_form.method = "POST";
        modal_form.action = "/update_meeting";
        console.log(modal_form);
        document.querySelector("#modal-heading").textContent = "Edit Meeting Details";
        document.querySelector("#modal-btn").style.display = "";
