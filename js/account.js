...
document.querySelector("#add-btn").addEventListener("click", () => {
    ...
    setLabelsInactive();
    setInputsOfModal({ name: "", email: "", phone: "", website: "", type: "", gstin: "", description: "",
        billingstreet: "", billingcity: "", billingstate: "", billingcountry: "", billingpostal: "",
        shippingstreet: "", shippingcity: "", shippingstate: "", shippingcountry: "", shippingpostal: "" }, false);
...
const getValues = (element) => {
    ...
    return { name, phone, email, website, gstin, description, type,
        billingstreet, billingcity, billingstate, billingcountry, billingpostal,
        shippingstreet, shippingcity, shippingstate, shippingcountry, shippingpostal };
}
